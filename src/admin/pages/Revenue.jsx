...
const Revenue = () => {
    return (
        <div className='w-full bg-gray-100 xl:p-3 sm:p-8 '>
            ...
            <div className='bg-white p- sm:px-5 rounded-2xl shadow-sm overflow-y-scroll xl:h-[45vh]'>
                <div className='min-w-[600px] sm:min-w-full'>
                    <table className='w-full text-left border-collapse'>
                       <thead className="sticky top-0 bg-white z-10 text-sm [&>tr>th]:py-3 sm:[&>tr>th]:py-4 xl:text-lg font-medium text-gray-600 border-b-black">
                            <tr >
                                <th>Customer Name</th>
                                <th>Contact No</th>
                                <th>Email</th>
