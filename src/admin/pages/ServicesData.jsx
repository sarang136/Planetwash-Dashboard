const ServicesData = ({ service }) => {
  return (
    <div className="max-h-[40vh] overflow-y-auto border border-gray-300 shadow-md rounded-lg">


      <table className="w-full border-collapse border border-gray-300 shadow-md rounded-lg overflow-y-scroll">
